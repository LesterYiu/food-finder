...
import { handleClicked, handleSubmit } from '../customFunctions/handleClicks';
        ...
        <form name="cuisineForm" onSubmit={(event) => {handleSubmit(event, setIsFirstQuestion, setIsSecondQuestion)}}>
            ...
            <Carousel breakPoints={breakPoints} enableMouseSwipe={true}>
                ...
                <div className="foodContainer">
                    ...
                    <input id="american" type="checkbox" name="cuisine" value="american" className="sr-only" onClick={(e) => handleClicked(e, setIsAmericanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="british" type="checkbox" name="cuisine" value="british" className="sr-only" onClick={(e) => handleClicked(e, setIsBritishChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="cajun" type="checkbox" name="cuisine" value="cajun" className="sr-only" onClick={(e) => handleClicked(e, setIsCajunChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="carribean" type="checkbox" name="cuisine" value="caribbean" className="sr-only" onClick={(e) => handleClicked(e, setIsCarribeanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="chinese" type="checkbox" name="cuisine" value="chinese" className="sr-only" onClick={(e) => handleClicked(e, setIsChineseChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="eastern european" type="checkbox" name="cuisine" value="eastern european" className="sr-only" onClick={(e) => handleClicked(e, setIsEastEuropeanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="european" type="checkbox" name="cuisine" value="european" className="sr-only" onClick={(e) => handleClicked(e, setIsEuropeanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="french" type="checkbox" name="cuisine" value="french" className="sr-only" onClick={(e) => handleClicked(e, setIsFrenchChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="german" type="checkbox" name="cuisine" value="german" className="sr-only" onClick={(e) => handleClicked(e, setIsGermanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="greek" type="checkbox" name="cuisine" value="greek" className="sr-only" onClick={(e) => handleClicked(e, setIsGreekChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="indian" type="checkbox" name="cuisine" value="indian" className="sr-only" onClick={(e) => handleClicked(e, setIsIndianChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="irish" type="checkbox" name="cuisine" value="irish" className="sr-only" onClick={(e) => handleClicked(e, setIsIrishChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="italian" type="checkbox" name="cuisine" value="italian" className="sr-only" onClick={(e) => handleClicked(e, setIsItalianChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="japanese" type="checkbox" name="cuisine" value="japanese" className="sr-only" onClick={(e) => handleClicked(e, setIsJapaneseChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="jewish" type="checkbox" name="cuisine" value="jewish" className="sr-only" onClick={(e) => handleClicked(e, setIsJewishChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="korean" type="checkbox" name="cuisine" value="korean" className="sr-only" onClick={(e) => handleClicked(e, setIsKoreanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="latin american" type="checkbox" name="cuisine" value="latin american" className="sr-only" onClick={(e) => handleClicked(e, setIsLatinAmericaChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="mediterranean" type="checkbox" name="cuisine" value="mediterranean" className="sr-only" onClick={(e) => handleClicked(e, setIsMediterraneanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="mexican" type="checkbox" name="cuisine" value="mexican" className="sr-only" onClick={(e) => handleClicked(e, setIsMexicanChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="middle eastern" type="checkbox" name="cuisine" value="middle eastern" className="sr-only" onClick={(e) => handleClicked(e, setIsMiddleEasternChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="nordic" type="checkbox" name="cuisine" value="nordic" className="sr-only" onClick={(e) => handleClicked(e, setIsNordicChecked, userCuisine, setUserCuisine)}/>
                    <p className="cuisineIdentifier" aria-hidden="true" onClick={(e) => handleTitleClick(e, setIsNordicChecked, userCuisine, setUserCuisine)}>Nordic</p>
                </div>
                <div className="foodContainer">
                    ...
                    <input id="southern" type="checkbox" name="cuisine" value="southern" className="sr-only" onClick={(e) => handleClicked(e, setIsSouthernChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="spanish" type="checkbox" name="cuisine" value="spanish" className="sr-only" onClick={(e) => handleClicked(e, setIsSpanishChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="thai" type="checkbox" name="cuisine" value="thai" className="sr-only" onClick={(e) => handleClicked(e, setIsThaiChecked, userCuisine, setUserCuisine)}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="vietnamese" type="checkbox" name="cuisine" value="vietnamese" className="sr-only" onClick={(e) => handleClicked(e, setIsVietnameseChecked, userCuisine, setUserCuisine)}/>
