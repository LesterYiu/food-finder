...
const CuisineForm = (props) => {
    ...
    const {breakPoints, setUserCuisine, userCuisine} = props;
        ...
        <form action="">
            ...
            <Carousel focusOnSelect={true} breakPoints={breakPoints}>
                ...
                <div className="foodContainer">
                    ...
                    <input id="american" type="checkbox" name="cuisine" value="american" className="sr-only" onClick={handleClick}/>
                    <p className="cuisineIdentifier" aria-hidden="true">American</p>
                </div>
                <div className="foodContainer">
                    <label htmlFor="british" className="british choice"><span className="sr-only">British</span></label>
                    <input id="british" type="checkbox" name="cuisine" value="british" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="cajun" type="checkbox" name="cuisine" value="cajun" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="caribbean" type="checkbox" name="cuisine" value="caribbean" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="chinese" type="checkbox" name="cuisine" value="chinese" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="eastern european" type="checkbox" name="cuisine" value="eastern european" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="european" type="checkbox" name="cuisine" value="european" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="french" type="checkbox" name="cuisine" value="french" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="german" type="checkbox" name="cuisine" value="german" className="sr-only" onClick={handleClick}/>
                    <p className="cuisineIdentifier" aria-hidden="true">German</p>
                </div>
                <div className="foodContainer">
                    <label htmlFor="greek" className="greek choice"><span className="sr-only">Greek</span></label>
                    <input id="greek" type="checkbox" name="cuisine" value="greek" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="indian" type="checkbox" name="cuisine" value="indian" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="irish" type="checkbox" name="cuisine" value="irish" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="italian" type="checkbox" name="cuisine" value="italian" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="japanese" type="checkbox" name="cuisine" value="japanese" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="jewish" type="checkbox" name="cuisine" value="jewish" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="korean" type="checkbox" name="cuisine" value="korean" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="latin american" type="checkbox" name="cuisine" value="latin american" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="mediterranean" type="checkbox" name="cuisine" value="mediterranean" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="mexican" type="checkbox" name="cuisine" value="mexican" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="middle eastern" type="checkbox" name="cuisine" value="middle eastern" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="nordic" type="checkbox" name="cuisine" value="nordic" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="southern" type="checkbox" name="cuisine" value="southern" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="spanish" type="checkbox" name="cuisine" value="spanish" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="thai" type="checkbox" name="cuisine" value="thai" className="sr-only" onClick={handleClick}/>
                ...
                <div className="foodContainer">
                    ...
                    <input id="vietnamese" type="checkbox" name="cuisine" value="vietnamese" className="sr-only" onClick={handleClick}/>
